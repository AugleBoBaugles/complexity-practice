...
public class Main {
  ...
  // The time complexity is:
  // O(n) - calling method with O(n) complexity
  ...
  // What would be a good choice of data structure?
  // ArrayList (LinkedList if by "accessing them by their position in the playlist" you mean the user's position, not the song position)
